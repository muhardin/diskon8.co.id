                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="review-tab-pro-inner">
                            <ul id="myTab3" class="tab-review-design">
                                <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i> Add New Akun Bank</a></li>
                            </ul>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" name="bank_account_name" class="form-control" placeholder="PT ABCD Alfabeth" value="{{ old('bank_account_name') }}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <label>Nomor Rekening </label>
                                                        <input type="number" name="bank_account_number" class="form-control" placeholder="1422299292" value="{{ old('bank_account_number') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
