         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="alert-icon shadow-reset wrap-alert-b">
               <div class="alert alert-success alert-st-one" role="alert">
                  <p class="message-mg-rt"><strong>Selamat datang, </strong> {{ Auth::user()->name }}</p>
               </div>
               @if ($information)
               <div class="alert alert-success alert-st-one" role="alert">
                  <p class="message-mg-rt">{!! $information->information !!}</p>
               </div>
               @endif
            </div>
         </div>
         ...
         <div class="row">
               ...
               <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                  ...
                  <div class="row vertical-center-box vertical-center-box-tablet">
                     ...
                     <div class="col-xs-9 cus-gh-hd-pro">
                        <h2 class="text-right no-margin">Rp. {{number_format($resellerProfit)}}</h2>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
               <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                  <h4 class="text-left text-uppercase"><b>Item Terjual</b></h4>
                  <div class="row vertical-center-box vertical-center-box-tablet">
                     <div class="text-left col-xs-3 mar-bot-15">
                        <label class="label bg-red">15% <i class="fa fa-level-down" aria-hidden="true"></i></label>
                     </div>
                     <div class="col-xs-9 cus-gh-hd-pro">
                        <h2 class="text-right no-margin">{{$sold}}</h2>
                     </div>
                  </div>
                  <div class="progress progress-mini">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
               <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                  <h4 class="text-left text-uppercase"><b>Transaksi</b></h4>
                  <div class="row vertical-center-box vertical-center-box-tablet">
                     <div class="text-left col-xs-3 mar-bot-15">
                        <label class="label bg-blue">50% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                     </div>
                     <div class="col-xs-9 cus-gh-hd-pro">
                        <h2 class="text-right no-margin">{{$transactions}}</h2>
                     </div>
                  </div>
                  <div class="progress progress-mini">
