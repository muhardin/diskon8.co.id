                        ...
                        <div class="review-tab-pro-inner">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    ...
                                    <form method="POST" action="{{ route('reseller.update', $data->user_id) }}">
                                        @csrf
                                        {{method_field('put')}}
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" name="domain" class="form-control" placeholder="Domain" value="{{ $data->domain }}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span>
                                                        <input type="text" name="company_name" class="form-control" placeholder="Nama Toko" value="{{ $data->company_name }}">
                                                    </div>
                                                    <div class="">
                                                        <label>Paket Reseller</label>
                                                        <select name="reseller_package_id" class="form-control pro-edt-select form-control-primary">
                                                            @foreach($packages as $key => $package)
                                                                @if ($data->reseller_package_id == $package->id)
