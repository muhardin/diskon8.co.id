...
@if(Session::get('addedcart'))
<script>
   swal("Berhasil !", "Product Ditambahkan !", "success");
</script>
@elseif(Session::get('warning'))
<script>
        swal("Warning !", "Keranjang Belanja Kosong", "warning");
</script>
@endif
...
<div class="main">
    <div class="wrapper">
        ...
        <div class="search-content" :class="wTop<3?'wbox':''">
            <a class="class" name="index_none_header_syfl" href="#"></a>
            <a class="wbox-flex search-bar pr" style="padding: 0px;margin: 0px 0px 0px 48px;" href="#">
                <div class="scan"></div><input type="text" disabled="disabled" v-model="q.key"
                    placeholder="cari produk">
            </a>
        <a href="#" name="index_none_header_sydl" class="mybtn myBtnNoLogin"></a>
        </div>
        <div class="swiper-container">
            <div class="swiper-wrapper">
                @if($frontslide->count() < 1)
                <div class="swiper-slide"><a href="#"><img
                    src="http://yy.jiaoyoumao.com/dacuige/20190520/18545178701414.jpg"></a></div>
                @else
                @foreach($frontslide as $frontslidedt)
                <div class="swiper-slide"><a href="#"><img
                    src="{{asset('images/slides/'.$frontslidedt->picture)}}" width="750" height="375"></a></div>
                @endforeach
                @endif
                <!--
                <div class="swiper-slide"><a href="Fumfo.html"><img
                            src="http://yy.jiaoyoumao.com/dacuige/20190520/18545178701414.jpg"></a></div>
                <div class="swiper-slide"><a href="Fumfn.html"><img
                            src="http://yy.jiaoyoumao.com/dacuige/20190520/1854402544a611.jpg"></a></div>
                <div class="swiper-slide"><a href="Fumfd.html"><img
                            src="http://yy.jiaoyoumao.com/dacuige/20190520/1855459900e1a1.jpg"></a></div>
                -->
            </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="ioc-boxs">
                        ...
                        <div class="ioc-box">
                            <a href="{{url('/front/category/'.@$categorydt->id)}}" title="Tas wanita"><img
                                    alt="Tas wanita"
                                    src="{{asset('/images/category/'.@$categorydt->gambar)}}"><span>{{$categorydt->name}}</span></a>
                        </div>
                        @endforeach
    ...
    <div class="ioc-box">
                ...
                <div class="swiper-slide">
                    <div class="ioc-boxs">
                        <div class="ioc-box">
                            <a href="#" title="Dompet"><img alt="Dompet"
                                    src="http://yy.jiaoyoumao.com/dacuige/20190520/160022945167bb.jpg"><span>Dompet</span></a>
                        </div>
                        <div class="ioc-box">
                            <a href="seek_data.html?type=Sepatu wanita" title="Sepatu wanita"><img alt="Sepatu wanita"
                                    src="http://yy.jiaoyoumao.com/dacuige/20190522/102620152fd102.jpg"><span>Sepatu
                                    wanita</span></a>
                        </div>
                        <div class="ioc-box">
                            <a href="#" title="Bepergian"><img alt="Bepergian"
                                    src="http://yy.jiaoyoumao.com/dacuige/20190516/210727814d26fe.png"><span>Bepergian</span></a>
                        </div>
                        <div class="ioc-box">
                            <a href="#" title="Kebutuhan sehari-hari"><img
                                    alt="Kebutuhan sehari-hari"
                                    src="http://yy.jiaoyoumao.com/dacuige/20190520/1631361630e8d5.jpg"><span>Kebutuhan
                                    sehari-hari</span></a>
                        </div>
                        <div class="ioc-box">
                            <a href="#" title="Kosmetik"><img alt="Kosmetik"
                                    src="http://yy.jiaoyoumao.com/dacuige/20190530/190520171efa1d.jpg"><span>Kosmetik</span></a>
                        </div>
                        <div class="ioc-box">
                            <a href="s#" title="Rok dan celana"><img
                                    alt="Rok dan celana"
                                    src="http://yy.jiaoyoumao.com/dacuige/20190612/152702149228aa.png"><span>Rok dan
                                    celana</span></a>
                        </div>
                        <div class="ioc-box">
                            <a href="#"><img alt="" src="/front/images/type_ioc_big.png"><span>Kategori</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="love_add">
            <div class="type_main"><span class="type_name">Produk terpopuler</span>
                <div class="type_body">
                    ...
                    $j=1;
                    @endphp
                    @foreach ($collectionfront as $item)
                    @php
                    $a=$i++;
                    $b=$j++;
                    if($a == 3){
                    ...
                    @if($b==7)
                    @php $j=1; @endphp
                    <div onclick="location.href='{{url('/productdetail/'.@$item->product_id)}}';" data-id="" class="data_list_small list_left">
                        <div class="img_body"><img src="{{asset('images/products/'.$item->main_image)}}"><span></span></div>
                        <div class="data_desc"><span class="data_name">{{$item->name}}</span> <span
                                class="price"><span class="data_price">Rp. <font>{{@number_format($item->agent_price,0)}}</font></span><span
                                    class="data_price_old">Rp. 
                                    @if(@$item->harga_coret)
                                    <font>{{@number_format($item->harga_coret,0)}}</font>
                                    @else
                                    <font>{{@number_format($item->agent_price+289000,0)}}</font>
                                    @endif
                                </span></span>
                            <div class="data_buy">Add to Cart</div>
                        </div>
                    </div>
                    <div onclick="location.href='{{url('/productdetail/'.@$item->product_id)}}';" data-id="" class="data_list_small">
                        <div class="img_body"><img src="{{asset('images/products/'.$item->main_image)}}"><span></span></div>
                        <div class="data_desc"><span class="data_name">{{$item->name}}</span> <span class="price"><span class="data_price">RP<font>{{@number_format($item->agent_price,0)}}</font></span><span
                                    class="data_price_old">Rp. 
                                    @if(@$item->harga_coret)
                                    <font>{{@number_format($item->harga_coret,0)}}</font>
                                    @else
                    ...
                    @else
                    <div onclick="location.href='{{url('/productdetail/'.@$item->product_id)}}';" data-id="1006075"
                        class="data_list_small2 {{@$left}}">
                        <div class="img_body"><img width="100" height="150"
                                src="{{asset('images/products/'.$item->main_image)}}"><span></span></div>
                        <div class="data_desc"><span class="data_name">{{$item->name}}</span> <span class="price"><span
                                    class="data_price">Rp. <font>{{@number_format($item->agent_price,0)}}</font>
                                    </span><span class="data_price_old"><br>Rp.
                                    @if(@$item->harga_coret)
                                    <font>{{@number_format($item->harga_coret,0)}}</font>
                                    @else
                                    <font>{{@number_format($item->agent_price+289000,0)}}</font>
        ...
        <div class="love" v-if="false">
            ...
            <ul>
                <li v-for="item in goods.list"><a href="javascript:void(0)" onclick="toData(this)"
                        :data-id="item.showId"><img :src="item.primaryPicUrl">
                        <dl>
                            <dt style="font-weight: bold;">
                                <font v-text="item.name"></font>
                            </dt>
                            <dd style="font-weight: bold;"> RP<font v-text="item.retailPrice"></font>(VNĐ) <span>RP<font
                                        v-text="item.marketPrice"></font></span></dd>
                        </dl>
                    </a></li>
            </ul>
        </div>
        ...
        <div style="border:2px solid #EF002E;">
            <p
                style="background: #EF002E; color: #FFF; text-align: center; line-height: 40px; height: 40px; font-size: 16px;">
                Untuk produk lain, silahkan scroll ke atas</p>
            <p
                style="font-size: 17px;font-weight: 400; padding:15px; color: #F1244C; line-height: 25px;background-color: #fff;">
    ...
    <p id="back_top" style="width:40px;position:fixed;top:81%;right:5%;"><a href="#top"><img
                src="front/picture/top_1.png"></a></p>
    <p id="back_top" style="width:40px;position:fixed;top:75%;right:5%;"><a href="{{url('/cart')}}"><img
                src="https://cdn.iconscout.com/icon/premium/png-256-thumb/shopping-cart-71-543136.png"></a></p>
    
    @if(@$collectionsum > 0)
    <a href="{{url('/cart')}}"><font style="
        position:fixed;
        top:75%;
        right:4.5%;
        border-radius: 50%;
        ...
        width: 25px;
        height: 25px;
        text-align: center;" size='4' color='white'>{{@$collectionsum}}</font></a>
    @endif
</div>
