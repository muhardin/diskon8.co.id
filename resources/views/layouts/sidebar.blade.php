<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="{{ route('home') }}"><img class="main-logo" width="100" height="100" src="{{ asset('img/ultimate_logo.jpeg') }}" alt="" /></a>
        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    <li>
                        <a title="Dashboard" href="{{ route('home') }}"><i class="fa big-icon fa-home icon-wrap" aria-hidden="true"></i> <span class="mini-sub-pro">Dashboard</span></a>
                    </li>
                    <li>
                        <a title="Katalog" href="{{ route('catalog.index') }}"><i class="fa fa-cube sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Katalog</span></a>
                    </li>

                    @if (Auth::user()->user_type == 'reseller')
                        <li>
                            <a title="Kupon" href="{{ route('coupon.index') }}"><i class="fa fa-percent sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Kupon</span></a>
                        </li>
                        <li>
                            <a title="Gajian" href="{{ route('wallet.index') }}"><i class="fa fa-money sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Gajian</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="fa big-icon fa-flask icon-wrap"></i> <span class="mini-click-non">Pesanan</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Prospek" href="{{ route('order.prospect') }}"><i class="fa fa-map-marker sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Prospek</span></a></li>
                                <li><a title="Pesanan Masuk" href="{{ route('order.index') }}"><i class="fa fa-map-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Pesanan Masuk</span></a></li>
                                <li><a title="Konfirmasi" href="{{ route('order.confirm') }}"><i class="fa fa-file-pdf-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Konfirmasi Pesanan</span></a></li>
                                {{--<li><a title="X-Editable" href="x-editable.html"><i class="fa fa-fighter-jet sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Pembayaran Diterima</span></a></li>--}}
                                <li><a title="Packing" href="{{ route('order.packing') }}"><i class="fa fa-code sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Packing</span></a></li>
                                <li><a title="Sedang DIkirim" href="{{ route('order.delivering') }}"><i class="fa fa-frown-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Pengiriman</span></a></li>
                                <li><a title="Diterima" href="{{ route('order.success') }}"><i class="fa fa-circle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Diterima Pembeli</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a title="Lacak Pesanan" href="{{ route('order.tracking') }}"><i class="fa fa-search sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lacak Pesanan</span></a>
                        </li>
                    @else
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-flask icon-wrap"></i> <span class="mini-click-non">Produk</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Produk Kategori" href="{{ route('category.index') }}"><i class="fa fa-map-marker sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Kategori</span></a></li>
                                <li><a title="Produk" href="{{ route('product.index') }}"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">List</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a title="Reseller Dashboard" href="{{ route('resellerDashboard.create') }}"><i class="fa fa-search sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Reseller Dashboard</span></a>
                        </li>
                        <li>
                            <a title="Paket Reseller" href="{{ route('resellerPackage.index') }}"><i class="fa fa-bookmark sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Paket Reseller</span></a>
                        </li>
                        <li>
                            <a title="Reseller" href="{{ route('reseller.index') }}"><i class="fa fa-female sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Reseller</span></a>
                        </li>
                        <li>
                            <a title="Akun Bank" href="{{ url('/order') }}"><i class="fa fa-cart-plus sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Order</span></a>
                        </li>
                        <li>
                        
                            {{-- 
                        <a title="Withdraw" href="{{ route('wallet.admin') }}"><i class="fa fa-get-pocket sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Withdraw</span></a>
                        --}}

                        <a class="has-arrow" href="" aria-expanded="false"><i class="fa fa-get-pocket sub-icon-mg"></i> <span class="mini-click-non">Wallet</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="List Withdraw" href="{{ route('wallet.admin') }}"><i class="fa fa-tasks sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Withdraw</span></a></li>
                                <li><a title="History Withdraw" href="{{ route('wallet.history') }}"><i class="fa fa-tasks sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">History</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a title="Akun Bank" href="{{ route('bank.index') }}"><i class="fa fa-search sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Akun Bank</span></a>
                        </li>
                        <li>
                            <a title="Admin" href="{{ route('user.index') }}"><i class="fa fa-question-circle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Admin</span></a>
                        </li>
                    @endif
                    {{--<li>--}}
                        {{--<a title="FAQ" href=""><i class="fa fa-question-circle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">FAQ</span></a>--}}
                    {{--</li>--}}
                    {{--<li class="active">--}}
