...
@endphp
<head>
    <title> {{@$shop_->company_name}}</title>
    
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta content="ie=edge" http-equiv="x-ua-compatible">
    <link rel="shortcut icon" href="{{asset('images/'.@$shop_->favicon)}}">
                ...
                <div class="mm-logo-buttons-w">
                    <a class="mm-logo" href="#">
                        <script data-pagespeed-no-defer>
                            ...
                            //pagespeed.CriticalImages.Run('/ngx_pagespeed_beacon', '{{url('/admin/catalog')}}', 'v84etq1rMa', true, false, 'Vd_JKY37SVs');
                        </script>
                        <img src="{{url('../members/img/logo.png')}}" data-pagespeed-url-hash="2837788309" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"><span>{{@Auth::user()->name}}</span></a>
    ...
    $(document).ready(function(){
        ...
        $('.btn-reset-desc').click(function (e) {
            ...
            swal({
                ...
                if(e.value) {
                    ...
                    data.shoproduct_id  = {{@$collectionproduct->shop_product_id}};
                    $('.overlay').show();
                    axios.post('{{url('/api/resetdesc')}}', data, {
                        headers: {
        ...
        $('#updateProduct').submit(function(e){
            e.preventDefault()
                ...
                data.display_price_show  = $('#display_price_show').val().trim();
