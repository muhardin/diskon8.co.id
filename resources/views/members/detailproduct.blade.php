            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="element-box">
                        <div class="row">
                                    ...
                                    <div id="myCarousel" class="carousel slide" data-interval="false">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="active  text-center item carousel-item">
                                                <img src="{{asset('images/products/'.$collectiondetail->main_image)}}" width="540" height="540" class="img-fluid magnify" data-large-img-url="https://asset-satujuan-live.sgp1.cdn.digitaloceanspaces.com/file/2018/12/5c0f8a13a7b00_780.jpg" data-pagespeed-url-hash="1459413726" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                                            </div>
                                            @php
                                                $i=1;
                                            @endphp
                                        ...
                                        <ul class="carousel-indicators list-inline border px-5 py-2 mt-3 bg-light" style="width:345px; max-width: 450px;">
                                            <li class="list-inline-item active">
                                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel">
                                                    <img src="{{asset('images/products/'.$collectiondetail->main_image)}}" style="height:50px;width:50px" data-pagespeed-url-hash="3835707922" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                                                </a>
                                            </li>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-7 text-primary">Rp. {{number_format($pricepackage->agent_price,0)}}</div>
                                </div>
                                <div class="row mb-1">
                        ...
                        <textarea class="form-control" name="konten" rows="12" cols="50" style="display:none;">{!! @$collectiondetail->description !!}</textarea>
                        <div class="tab-content" id="deskripsi">
                            <p class="text-justify">
                                ...
                                -->
                                <h5>Berat</h5>
                                <p>{{@$collectiondetail->weight." Gram"}}</p>
                            </p>
                        </div>
                        <div class="tab-content" id="stock">
                            <table class="table table-bordered table-lg table-v2 table-striped">
                                ...
                                <tbody>
                                    @foreach ($stockproduct as $stockproductdata)
                                    <tr>
                                            <td rowspan="1">{{@$stockproductdata->color}}</td>
                                            <td>ALL</td>
                                            <td>{{@$stockproductdata->stock}}</td>
                                        </tr>
                                    @endforeach
                ...
                <div class="col-md-5">
                    ...
                    <form class="form" action="#" id="addProduct">
                        <input type="hidden" value="{{@$collection->id}}" name="product_id">
                        ...
                        <div class="element-box m-0" style="border-bottom-right-radius: 0;border-bottom-left-radius: 0;border-top-right-radius: 4px;border-top-left-radius: 4px;">
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control m-0 priceformat" id='sell_price' name='price' placeholder="Masukkan Harga Jual" value="{{@$pricepackage->agent_price + @$collectiondetail->profit_limit}}">
                                </div>
                                <div class="col-md-5 my-2">
                                    <p class="font-weight-bold">Profit</p>
                                </div>
                                <div class="col-md-7">
                                    <input class="form-control m-0 priceformat" id='profit' placeholder="Masukkan Profit" value="" readonly name="profit">
                                </div>
                                <div class="col-md-12 my-2">
                                ...
                                <div class='col-md-12 my-2'>
                                    <table id='profit_list' style="width: 100%">
                                        ...
                                        <tr class='border-bottom'>
                                            ...
                                            <td class='profit' id='profit-1'></td>
                                        </tr>
                                        <tr class='border-bottom'>
                                            <td class="py-2">10 pcs</td>
                                            <td class='profit' id='profit-10'></td>
                                        </tr>
                                        <tr class='border-bottom'>
                                            <td class="py-2">25 pcs</td>
                                            <td class='profit' id='profit-25'></td>
                                        </tr>
                                        <tr class='border-bottom'>
                                            <td class="py-2">50 pcs</td>
                                            <td class='profit' id='profit-50'></td>
                                        </tr>
                                        <tr class='border-bottom'>
                                            <td class="py-2">150 pcs</td>
                                            <td class='profit' id='profit-150'></td>
                                        </tr>
                                        <tr class='border-bottom'>
                                            <td class="py-2">500 pcs</td>
                                            <td class='profit' id='profit-500'></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
